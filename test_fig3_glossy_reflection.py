...
test_name = "test_fig3_glossy_reflection"
        ...
        <scene version="2.0.0">
            ...
            <shape type="obj">
                <transform name="to_world">
                    ...
                    <rotate x="1.0" y="0.0" z="0.0" angle="22"/>
                </transform>
            ...
            <shape type="obj" id="object">
                ...
                <transform name="to_world">
                    <scale value="3.0"/>
                    <rotate x="0.0" y="0.0" z="1.0" angle="40"/>
                    <translate x="0.0" y="2.2" z="-1.0"/>
            ...
            <shape type="obj">
                <string name="filename" value="data/meshes/xy_plane_rough.obj"/>
                ...
                <transform name="to_world">
                    ...
                    <rotate x="1.0" y="0.0" z="0.0" angle="-70"/>
                </transform>
            </shape>
...
test_finite_difference(test_name + "/rotation", make_scene_rotation, get_diff_param_rotation,
    ...
    fd_integrator, fd_spp, fd_passes, 0.1)
